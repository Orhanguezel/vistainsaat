...
/* ---- helper: date range conditions (+ optional localhost exclusion) ---- */
function dateRangeConds(opts: { created_from?: string; created_to?: string; exclude_localhost?: any }): SQL[] {
  const conds: SQL[] = [];
...
export async function getTopEndpoints(opts: {
  created_from?: string;
  created_to?: string;
...
/* -------------------------------------------------------------
 * Slowest Endpoints (by avg response time, min 5 requests)
 * ------------------------------------------------------------- */
...
export async function getSlowestEndpoints(opts: {
  created_from?: string;
  created_to?: string;
  exclude_localhost?: any;
  limit?: number;
...
/* -------------------------------------------------------------
 * Top Users (by request count, with user info)
 * ------------------------------------------------------------- */
...
export async function getTopIps(opts: {
  created_from?: string;
  created_to?: string;
  exclude_localhost?: any;
  limit?: number;
...
export async function getStatusDistribution(opts: {
  created_from?: string;
  created_to?: string;
  exclude_localhost?: any;
...
export async function getMethodDistribution(opts: {
  created_from?: string;
  created_to?: string;
  exclude_localhost?: any;
...
export async function getHourlyBreakdown(opts: {
  created_from: string;
  created_to: string;
  exclude_localhost?: any;
}): Promise<HourlyRow[]> {
...
/* -------------------------------------------------------------
 * Response Time Stats (percentiles via OFFSET approach)
 * ------------------------------------------------------------- */
...
export async function getResponseTimeStats(opts: {
  created_from?: string;
  created_to?: string;
  exclude_localhost?: any;
  path?: string;
...
/* -------------------------------------------------------------
 * Dashboard Summary (today's overview)
 * ------------------------------------------------------------- */
...
export async function getAuditSummary(opts?: { exclude_localhost?: any }): Promise<AuditSummary> {
  ...
  // Slowest endpoint (min 3 requests today)
...
export async function getMonthlyAggregation(opts: {
  months?: number;
  exclude_localhost?: any;
}): Promise<MonthlyRow[]> {
